package com.mythos.demo.ui.view;
...
public class ScroListView extends ListView implements OnScrollListener {
	...
	public ScroListView(Context context, AttributeSet attrs, int defStyle) {
